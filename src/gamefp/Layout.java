...
class Layout {
	...
	public void draw(Graphics2D g){
        ...
        g.drawString("MERAH", 90, 35); // Drawing the text on top of the boxes
        g.drawString("HIJAU", 370, 35);
        g.drawString("BIRU", 90, 540);
        g.drawString("KUNING", 370, 540);
		g.setFont(new Font("MV Boli", Font.BOLD, 30));
        g.drawString("Press enter to roll dice", 550,150);
        g.drawString("press the pawn to move", 550,200);
    }
}
